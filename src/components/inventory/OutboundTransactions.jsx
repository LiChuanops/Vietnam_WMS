      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {selectedProducts.length > 0 ? (
          ...
          <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
            ...
            <p className="text-gray-500 mb-4">Use the filters above to find products and add them to your outbound transaction.</p>
            <p className="text-sm text-gray-400">Select products from the dropdown to start building your outbound transaction.</p>
          </div>
        )}
      </form>
    </div>
